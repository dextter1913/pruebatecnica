    ...
    <h1>Crear Actividad</h1>
        ...
        <div class="col-12 col-sm-4 col-md-4 col-lg-4 shadow p-3 mb-5 bg-body rounded">
            <form action="crear" method="post">
                ...
                <input type="text" name="nombreactividad" required="required" id="nombreactividad" class="form-control" placeholder="Nombre"><br/>
                <label for="actividad" class="text-white">Ingrese Actividad</label><br/>
                <textarea name="actividad" required="required" id="actividad" class="form-control" cols="30" rows="10" placeholder="Descripcion Actividad"></textarea><br/>
